...
Advanced portfolio optimization and analytics wrapper using PyPortfolioOpt.
Provides sophisticated portfolio construction, optimization methods, and risk analytics
including efficient frontier analysis, Black-Litterman model, and performance attribution.
...
INPUT:
  ...
  - Market views and confidences (optional)
...
PARAMETERS:
  - optimization_method: efficient_frontier, hrp, cla, black_litterman, efficient_semivariance
  - objective: max_sharpe, min_volatility, max_quadratic_utility, efficient_risk
  - risk_model_method: sample_cov, semicovariance, exp_cov, shrunk_covariance
  - expected_returns_method: mean_historical_return, ema_historical_return, capm_return
  - weight_bounds: (min_weight, max_weight) for position limits
  - risk_free_rate: Default 0.02 (2%)
  - gamma: L2 regularization parameter
  - total_portfolio_value: For discrete allocation
"""
