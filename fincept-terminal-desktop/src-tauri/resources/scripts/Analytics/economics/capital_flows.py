...
Implements CFA Level I Capital Flows and FX Market curriculum:
- Foreign exchange market functions and participants
- Nominal vs real exchange rates distinction
- Currency percentage change calculations and interpretations
- Exchange rate regimes and effects on international trade/capital flows
- Government capital restrictions objectives
- FX market structure, liquidity, and trading mechanisms
- Balance of payments impact on exchange rates
- Capital flow types and their economic implications
"""
