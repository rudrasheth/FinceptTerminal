...
Base classes, validators, exceptions, and common utilities for the economics module.
Provides foundation for all economic analysis components with CFA-compliant precision.
"""
