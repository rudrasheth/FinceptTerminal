...
Implements CFA Level II Economic Growth curriculum:
- Factors favoring/limiting growth in developed vs developing economies
- Stock market appreciation vs sustainable growth rate relationships
- Potential GDP and growth rate importance for equity/fixed income investors
- Capital deepening vs technological progress effects on growth/productivity
- Potential GDP forecasting using growth accounting relations
- Natural resources impact on economic growth and constraints
- Demographics, immigration, labor force participation effects
- Physical capital, human capital, technological development investment effects
- Classical, neoclassical, and endogenous growth theory comparisons
- Convergence hypotheses explanation and evaluation
- Government incentives for private technology/knowledge investment rationale
- Trade barrier removal impact on capital investment, employment, wages, growth
"""
