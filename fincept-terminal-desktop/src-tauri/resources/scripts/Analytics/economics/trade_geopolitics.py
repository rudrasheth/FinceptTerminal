...
- Geopolitics from cooperation vs competition perspective
- Geopolitics relationship with globalization
- International organizations (World Bank, IMF, WTO) functions/objectives
- Geopolitical risk assessment and tools impact
- Investment implications of geopolitical risk
- Trade barrier removal effects on capital, employment, wages, growth
"""
