...
Implements CFA Level I Exchange Rate Calculations curriculum:
- Currency cross-rate calculations and interpretations
- Arbitrage relationships between spot/forward rates and interest rates
- Forward rate calculations using points and percentage terms
- Forward discount/premium interpretations
- Percentage change calculations between currencies
- Professional-grade exchange rate mathematical operations
"""
