...
Implements CFA Level II Currency Exchange Rates curriculum:
- Bid-offer spreads and factors affecting spreads
- Triangular arbitrage opportunities and profit calculations
- Spot and forward rates with premium/discount calculations
- Mark-to-market forward contract valuations
- International parity conditions (covered/uncovered interest rate parity, PPP, Fisher effect)
- Long-run fair value assessment approaches
- Carry trade analysis and profit calculations
- Balance of payments impact on exchange rates
- Monetary/fiscal policy effects on exchange rates
- Central bank intervention and capital controls effectiveness
