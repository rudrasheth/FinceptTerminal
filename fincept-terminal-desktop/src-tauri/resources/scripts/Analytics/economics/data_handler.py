...
Universal data adapter and provider interfaces for the economics module.
Handles data from multiple sources including external APIs and manual input.
Provides standardized data formats and validation for all economic analysis modules.
"""
