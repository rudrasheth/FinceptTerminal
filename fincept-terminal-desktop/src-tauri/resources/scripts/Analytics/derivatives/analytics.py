...
INPUT:
  - Derivative instrument specifications: options, forwards, futures
  - Market data: spot prices, volatility surfaces, interest rates
  - Portfolio positions: quantities, entry prices, dates
  - Risk factor scenarios for stress testing

OUTPUT:
  - Portfolio risk metrics: VaR, CVaR, Greeks aggregation
  - Performance attribution by risk factor
  - Scenario analysis results and stress test outcomes
  - Sensitivity analysis and elasticity metrics
  - Portfolio optimization recommendations

PARAMETERS:
  - confidence_levels: List of confidence levels for VaR (default: [0.95, 0.99])
  - num_simulations: Monte Carlo simulation count (default: 10000)
  - time_horizon: Analysis horizon in days (default: 30)
  - optimization_objective: Portfolio objective (default: "sharpe_ratio")
"""
