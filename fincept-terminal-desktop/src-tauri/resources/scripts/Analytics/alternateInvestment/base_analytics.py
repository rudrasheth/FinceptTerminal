...
INPUT:
  - Alternative investment data: cash flows, market data, asset parameters
  - Price series for performance calculations
  - Asset metadata for parameter validation

OUTPUT:
  - Financial metrics: IRR, NPV, MOIC, DPI, RVPI
...
PARAMETERS:
  ...
  - risk_free_rate: Risk-free rate for Sharpe calculations (default: from config)
