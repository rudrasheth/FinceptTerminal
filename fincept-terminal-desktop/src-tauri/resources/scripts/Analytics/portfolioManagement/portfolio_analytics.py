...
INPUT:
  - Asset returns data: historical prices, returns series
  - Portfolio holdings: weights, asset allocations
  - Market benchmarks: index returns, risk-free rates
  - Asset metadata: asset classes, sectors, regions

OUTPUT:
  - Portfolio performance metrics: returns, volatility, Sharpe ratio
  - Risk decomposition: systematic vs. nonsystematic risk
  - Efficient frontier analysis and optimal portfolios
  - CAPM analysis: alpha, beta, Security Market Line
  - Attribution analysis and risk contribution metrics

PARAMETERS:
  - risk_free_rate: Risk-free rate for calculations (default: from config)
  ...
  - num_frontier_points: Efficient frontier points (default: 100)
"""
