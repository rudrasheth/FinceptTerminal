...
INPUT:
  - Fixed income securities: bonds, portfolios, yield curves
  - Market data: interest rates, yield curves, credit spreads
  - Bond specifications: coupons, maturities, credit ratings
  - Portfolio holdings and positions data

OUTPUT:
  - Duration measures: Macaulay, modified, effective, key rate durations
  - Convexity calculations and adjustments
  - Portfolio risk metrics: VaR, stress test results
  - Hedging analytics and optimal hedge ratios
  - Comprehensive risk reports and scenario analysis

PARAMETERS:
  - yield_shift: Basis points for duration calculations (default: 0.0001)
  - confidence_level: VaR confidence level (default: 0.95)
  - simulations: Monte Carlo simulation count (default: 10000)
  - time_horizon: Risk analysis horizon in years (default: 1)
"""
